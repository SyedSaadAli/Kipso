...
<body>
    ...
    <div class="page-wrapper">
        ...
        <section class="about-one about-one__about-page">
            ...
            <div class="container text-center">
                ...
                <div class="about-one__img">
                    <div class="row">
                        <div class="col-lg-6">
                            <img src="assets/images/about-2-1..jpg" alt="" height="298" width="570">
                        </div><!-- /.col-lg-6 -->
                        <div class="col-lg-6">
                            <img src="assets/images/about-2-2..jpg" alt="" height="298" width="570">
                        </div><!-- /.col-lg-6 -->
                    </div><!-- /.row -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="video-one__img">
                            <img src="assets/images/slider-2-2..jpg" alt="" height="437" width="570">
        ...
        <section class="cta-one cta-one__home-one" style="background-image: url(assets/images/cta-bg-1-1..jpg);"style="height:1280" style="width: 1920;" >
            <div class="container">

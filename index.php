                    ...
                    <div class="item">
                        <div class="course-one__single color-1">
                            ...
                            <div class="course-one__content">
                                ...
                                <h2 class="course-one__title"><a href="course-details.php">New react bootcamp</a></h2>
                                <!-- /.course-one__title -->
                                ...
                                <div class="course-one__meta">
                                    ...
                                    <a href="course-details.php">$18</a>
                    ...
                    <div class="item">
                        <div class="course-one__single color-2">
                            ...
                            <div class="course-one__content">
                                ...
                                <h2 class="course-one__title"><a href="course-details.php">Improve editing skills</a></h2>
                                <!-- /.course-one__title -->
                                <div class="course-one__stars">
                                    <span class="course-one__stars-wrap">
                                        <i class="fa fa-star"></i>
                    ...
                    <div class="item">
                        <div class="course-one__single color-3">
                            ...
                            <div class="course-one__content">
                                ...
                                <h2 class="course-one__title"><a href="course-details.php">Marketing strategies</a></h2>
                                <!-- /.course-one__title -->
                                <div class="course-one__stars">
                                    <span class="course-one__stars-wrap">
                                        <i class="fa fa-star"></i>
                    ...
                    <div class="item">
                        <div class="course-one__single color-4">
                            ...
                            <div class="course-one__content">
                                ...
                                <h2 class="course-one__title"><a href="course-details.php">Basics of photography</a></h2>
                                <!-- /.course-one__title -->
                                <div class="course-one__stars">
                                    <span class="course-one__stars-wrap">
                                        <i class="fa fa-star"></i>
                    ...
                    <div class="item">
                        <div class="course-one__single color-5">
                            ...
                            <div class="course-one__content">
                                ...
                                <h2 class="course-one__title"><a href="course-details.php">Affiliate bootcamp</a>
                                </h2>
                                <!-- /.course-one__title -->
                                <div class="course-one__stars">
                                    <span class="course-one__stars-wrap">
                        ...
                        <div class="course-one__single color-6">
                            ...
                            <div class="course-one__content">
                                ...
                                <div class="course-one__admin">
                                    ...
                                    by <a href="teacher-details.php">Katherine Collins</a>
                                </div><!-- /.course-one__admin -->
                                <h2 class="course-one__title"><a href="course-details.php">Healthy workout tips </a></h2>
                                <!-- /.course-one__title -->
                                <div class="course-one__stars">
                                    <span class="course-one__stars-wrap">
                                        <i class="fa fa-star"></i>
                    ...
                    <div class="col-lg-6">
                        <div class="become-teacher__form">
                            ...
                            <form action="code.php" method="post" class="become-teacher__form-content contact-form-validated">
                                ...
                                <button type="submit" name="Apply_btn" class="thm-btn become-teacher__form-btn">Apply For It</button>
                    ...
                    <div class="item">
                        <div class="blog-two__single" style="background-image: url(assets/images/blog-2-1.jpg);">
                            <div class="blog-two__inner">
                                <a href="news-details.php" class="blog-two__date">
                                    <span>25</span>
                                    Jul
                                </a><!-- /.blog-two__date -->
                                ...
                                <h3 class="blog-two__title">
                                    <a href="news-details.php">Summer high school journalism camp</a>
                                </h3><!-- /.blog-two__title -->
                            </div><!-- /.blog-two__inner -->
                    ...
                    <div class="item">
                        <div class="blog-two__single" style="background-image: url(assets/images/blog-2-2.jpg);">
                            <div class="blog-two__inner">
                                ...
                                <h3 class="blog-two__title">
                                    <a href="news-details.php">Get a tips to develop a quality education</a>
                                </h3><!-- /.blog-two__title -->
                            </div><!-- /.blog-two__inner -->
                        </div><!-- /.blog-two__single -->
                    </div><!-- /.item -->
                    <div class="item">
                        <div class="blog-two__single" style="background-image: url(assets/images/blog-2-3.jpg);">
                            <div class="blog-two__inner">
                                ...
                                <h3 class="blog-two__title">
                                    <a href="news-details.php">Learn variety of programs and courses</a>
                                </h3><!-- /.blog-two__title -->
                            </div><!-- /.blog-two__inner -->
                        </div><!-- /.blog-two__single -->
                    </div><!-- /.item -->
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 d-flex">
                        <div class="my-auto">
                            <form action="code.php" method="POST" class="mailchimp-one__form mc-form">
                                <input type="text"  id="mc-email"  placeholder="Enter your email "  name="Email">
                                <button type="submit"  class="thm-btn"  name="subscribe_btn">Subscribe</button>

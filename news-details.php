...
<head>
    ...
    <title>News Details || Kipso || Online Education Learning & LMS HTML Template</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <form action="code.php" method="post" class="reply-form">
                            <div class="row">
                                <div class="col-lg-6">
                                    <input type="text" name="Name" placeholder="Your name" class="reply-form__field">
                                </div><!-- /.col-lg-6 -->
                                <div class="col-lg-6">
                                    <input type="text" name="Email" placeholder="Enter email" class="reply-form__field">
                                </div><!-- /.col-lg-6 -->
                                <div class="col-lg-12">
                                    <textarea name="Comment" placeholder="Write message" class="reply-form__field"></textarea>
                                    <button class="reply-form__btn thm-btn" type="submit" name="comment_btn">Submit Comment</button>
                                </div><!-- /.col-lg-12 -->
                            </div><!-- /.row -->
                        </form><!-- /.reply-form -->
                    </div><!-- /.col-lg-8 -->

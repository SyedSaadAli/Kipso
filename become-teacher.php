...
<body>
                ...
                <div class="container clearfix">
                    ...
                    <div class="logo-box clearfix">
                        ...
                        <div class="header__social">
                            ...
                            <a href="https://www.instagram.com/avairosoft_"><i class="fab fa-instagram"></i></a>                        </div><!-- /.header__social -->
  ...
  ?> 
                            ...
                            <form action="code.php" method="post" class="become-teacher__form-content contact-form-validated">
                                <input type="text" name="Teacher_Name" placeholder="Your Name" required>
                                <input type="text" name="Teacher_Email" placeholder="Email Address" required>
                                <input type="text" name="Teacher_PhoneNumber" placeholder="Phone Number" required>
                                <input type="text" name="Teacher_message" placeholder="Comment" required>
                                <button type="submit" name="become_teacher_btn" class="thm-btn become-teacher__form-btn">Apply For It</button>
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="team-one__single">
                            ...
                            <div class="team-one__content">
                                <h2 class="team-one__name"><a href="team-details.php">Adelaide Hunter</a></h2>
                                <!-- /.team-one__name -->
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="team-one__single">
                            ...
                            <div class="team-one__content">
                                <h2 class="team-one__name"><a href="team-details.php">Christina Newman</a></h2>
                                <!-- /.team-one__name -->
                                <p class="team-one__designation">Teacher</p><!-- /.team-one__designation -->
                                <p class="team-one__text">There are many varia of passages of lorem.</p>
                                <!-- /.team-one__text -->
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="team-one__single">
                            ...
                            <div class="team-one__content">
                                <h2 class="team-one__name"><a href="team-details.php">Gilbert Daniels</a></h2>
                                <!-- /.team-one__name -->
                                <p class="team-one__designation">Teacher</p><!-- /.team-one__designation -->
                                <p class="team-one__text">There are many varia of passages of lorem.</p>
                                <!-- /.team-one__text -->
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="team-one__single">
                            ...
                            <div class="team-one__content">
                                <h2 class="team-one__name"><a href="team-details.php">Austin Caldwell</a></h2>
                                <!-- /.team-one__name -->
                                <p class="team-one__designation">Teacher</p><!-- /.team-one__designation -->
                                <p class="team-one__text">There are many varia of passages of lorem.</p>
                                <!-- /.team-one__text -->
